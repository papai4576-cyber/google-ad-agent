...
export const findings = pgTable("findings", {
  ...
  alternativeExplanations: jsonb("alternative_explanations").$type<string[]>().default([]),
  proposedChanges: jsonb("proposed_changes").$type<Array<{ type: string; params: Record<string, unknown> }>>().default([]),
